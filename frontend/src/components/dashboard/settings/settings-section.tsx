...
export function SettingsNote({ children }: { children: ReactNode }) {
  return (
    <div className="rounded-2xl border border-[var(--zf-accent-light-border)] bg-[var(--zf-accent-light-bg)] px-4 py-3 text-xs leading-relaxed text-slate-500 dark:border-[var(--zf-border)] dark:bg-[var(--zf-soft-fill)] dark:text-[var(--zf-text-muted)]">
      {children}
    </div>
  )
}
