...
export function ExpensesCard({
  ...
  return (
    <div className="rounded-3xl border border-slate-100/80 bg-white p-6 shadow-sm transition-[transform,box-shadow] duration-200 ease-out hover:shadow-md motion-safe:hover:-translate-y-0.5 dark:border-[var(--zf-border)] dark:bg-[var(--zf-surface)] dark:shadow-black/20 dark:hover:shadow-black/30">
      ...
      {loading ? (
        ...
        <div className="mb-6 space-y-3">
          <div>
            ...
            <p className="mt-0.5 text-xs font-semibold text-slate-500 dark:text-[var(--zf-text-muted)]">
              Spent this month
            </p>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-2xl bg-slate-50 px-3 py-2.5 dark:bg-[var(--zf-soft-fill)]">
              <p className="text-[11px] font-medium text-slate-500 dark:text-[var(--zf-text-muted)]">
                Budget
              </p>
      ...
      <div className="mb-6">
        <div className="flex h-2.5 overflow-hidden rounded-full border border-slate-100/30 bg-slate-50 dark:border-[var(--zf-border)]/40 dark:bg-[var(--zf-soft-fill)]">
          {segments.length === 0 ? (
            <div className="h-full w-full bg-slate-100 dark:bg-[var(--zf-elevated)]" />
          ) : (
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2 px-1">
        {segments.length === 0 ? (
          <p className="text-xs font-semibold text-slate-500 dark:text-[var(--zf-text-muted)]">
